...
import com.yangqi.recommendedsystem.controller.admin.AdminController;
...
public class ControllerAspect {
    ...
    @Around("execution(* com.yangqi.recommendedsystem.controller.admin.*.*(..)) && @annotation(org.springframework.web.bind.annotation" +
            ".RequestMapping)")
